        ...
        return (
            <Navbar color="light" light expand="md" className="fixed-top">
                <Link to="/" className="navbar-brand" onClick={this.handleLogoClick}>
                    <img src="/assets/images/logo.svg" className="img-fluid logo mr-3" alt="logo" />
                    DamjanKo.com
                </Link>
                ...
                <Collapse isOpen={!this.state.collapsed} navbar>
                    <Nav className="ml-auto" navbar>
                        ...
                        <NavItem>
                            <NavLink href="http://career.damjanko.com" target="_blank" onClick={this.handleSigninClick}>
                                Sign in
                            </NavLink>
                        </NavItem>
                    </Nav>
                    <Nav className="ml-auto" navbar>
                        <NavItem>
                            <NavLink href="mailto:letecnez@gmail.com" className="p-1" onClick={this.handleEmailClick}>
